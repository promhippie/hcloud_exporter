...
func RootFlags(cfg *config.Config) []cli.Flag {
	return []cli.Flag{
		...
		&cli.StringSliceFlag{
			Name:        "collector.floating-ips.labels",
			Value:       config.FloatingIPLabels(),
			Usage:       "List of labels used for floating IPs",
			Sources:     cli.EnvVars("HCLOUD_EXPORTER_FLOATING_IPS_LABELS"),
			Destination: &cfg.Target.FloatingIPs.Labels,
		},
		&cli.BoolFlag{
		...
		&cli.StringSliceFlag{
			Name:        "collector.images.labels",
			Value:       config.ImageLabels(),
			Usage:       "List of labels used for images",
			Sources:     cli.EnvVars("HCLOUD_EXPORTER_IMAGES_LABELS"),
			Destination: &cfg.Target.Images.Labels,
		},
		&cli.BoolFlag{
		...
		&cli.StringSliceFlag{
			Name:        "collector.servers.labels",
			Value:       config.ServerLabels(),
			Usage:       "List of labels used for servers",
			Sources:     cli.EnvVars("HCLOUD_EXPORTER_SERVERS_LABELS"),
			Destination: &cfg.Target.Servers.Labels,
		},
		&cli.BoolFlag{
		...
		&cli.StringSliceFlag{
			Name:        "collector.server-metrics.labels",
			Value:       config.ServerMetricsLabels(),
			Usage:       "List of labels used for server metrics",
			Sources:     cli.EnvVars("HCLOUD_EXPORTER_SERVER_METRICS_LABELS"),
			Destination: &cfg.Target.ServerMetrics.Labels,
		},
		&cli.BoolFlag{
		...
		&cli.StringSliceFlag{
			Name:        "collector.load-balancers.labels",
			Value:       config.LoadBalancerLabels(),
			Usage:       "List of labels used for load balancers",
			Sources:     cli.EnvVars("HCLOUD_EXPORTER_LOAD_BALANCERS_LABELS"),
			Destination: &cfg.Target.LoadBalancers.Labels,
		},
		&cli.BoolFlag{
		...
		&cli.StringSliceFlag{
			Name:        "collector.ssh-keys.labels",
			Value:       config.SSHKeyLabels(),
			Usage:       "List of labels used for SSH keys",
			Sources:     cli.EnvVars("HCLOUD_EXPORTER_SSH_KEYS_LABELS"),
			Destination: &cfg.Target.SSHKeys.Labels,
		},
		&cli.BoolFlag{
		...
		&cli.StringSliceFlag{
			Name:        "collector.volumes.labels",
			Value:       config.VolumeLabels(),
			Usage:       "List of labels used for volumes",
			Sources:     cli.EnvVars("HCLOUD_EXPORTER_VOLUMES_LABELS"),
			Destination: &cfg.Target.Volumes.Labels,
		},
		&cli.BoolFlag{
